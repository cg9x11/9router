...
export const WEB_COOKIE_PROVIDERS = {
  ...
  "deepseek-web": { id: "deepseek-web", alias: "dw", name: "DeepSeek Web", icon: "bolt", color: "#4D6BFE", textIcon: "DW", website: "https://chat.deepseek.com", authType: "cookie", authHint: "Paste your DeepSeek web access token. Accepts raw token or Bearer <token>.", serviceKinds: ["llm"] },
